//Runtime: 3256 ms, faster than 18.01% of Swift online submissions for Word Search.
//Memory Usage: 14.2 MB, less than 82.92% of Swift online submissions for Word Search.
...
class Solution {
    ...
    func exist(_ board: [[Character]], _ charArray: [Character], _ charIndex: Int, _ x: Int, _ y: Int, _ history: inout [[Int]: Bool]) -> Bool {
        if charIndex >= charArray.count { return true }
